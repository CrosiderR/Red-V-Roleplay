...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if(!interaction.member.roles.cache.get(yetkiliekibi) && !interaction.member.roles.cache.get(`1171473646745833553`) && !interaction.member.permissions.has(PermissionsBitField.Flags.Administrator)) return interaction.reply({ embeds: [yetkinyok], ephemeral: true });
